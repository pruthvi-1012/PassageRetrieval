...
public static void main(String[] args) throws Exception {
	...
	while ((line = in.readLine()) != null &&
      ...
      if (q.length() > 0) line = q.toString().trim(); 
      ...
      resultList = doPagingSearch(in, out, searcher, query, hitsPerPage, raw, queries == null && queryString == null, q_id);      
   ...
   * 
   */
  public static String[] doPagingSearch(BufferedReader in, String out_f, IndexSearcher searcher, Query query,
